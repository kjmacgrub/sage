...
def create_app() -> FastAPI:
    ...
    app.include_router(dividend_screener.router, prefix="/api/dividend-screener")
    app.include_router(dividend.router, prefix="/api/dividend")
